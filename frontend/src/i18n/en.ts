const en = {
  ...
  projectForm: {
    ...
    fieldPlannedObjects: 'Planned objects',
  ...
  detail: {
    ...
    kpiError: 'Could not load project KPIs.',
    kpiTotalFiles: 'Total files',
    kpiTotalFolders: 'Total folders',
    kpiPlannedObjects: 'Planned objects',
    kpiObjectFolders: 'Object folders created',
    kpiMissingObjectFolders: 'Missing object folders',
    kpiAverageObjectProgress: 'Average object progress',
    kpiProjectProgress: 'Project progress',
    objectFolder: 'Object',
  ...
  admin: {
    ...
    fieldProjectAccess: 'Project access',
    projectAccessHint: 'Hold Ctrl/Cmd to select multiple projects.',
    errorProjectAccess: 'Failed to load project access.',
    fieldRole: 'Role',
    roleAdmin: 'Admin',
    roleClient: 'Client',
